...
//{
//    [Serializable]
//    public class CellDropDownDate : CellEdit, IPopupEdit
//    { 
//        public CellDropDownDate(DataExcel grid)
//            : base(grid)
//        {
...
//        {
//            CellDropDownDate celledit = new CellDropDownDate(grid);
...
//        private DatePopupForm dropdownpopupform = null;
//        public void InitDropDownForm()
//        {
//            dropdownpopupform = new DatePopupForm();
...
//                this.Cell.Value = dateTime.Date;
//                this.Cell.Text = dateTime.ToString("yyyy-MM-dd");
//                HidePopup();
//                this.Grid.EndEdit();
//            }
//            catch (Exception ex)
