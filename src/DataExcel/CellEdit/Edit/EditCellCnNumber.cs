...
{ 
    public class CellCnNumber : CellBaseEdit, IEdit,ICellEditControl
    {
        public override string ShortName { get { return "CellCnNumber"; } set { } }
        private NumTextBox edit = null;

        public CellCnNumber(DataExcel grid):
            base(grid)
        {
            edit = new NumTextBox();
        ...
        public override bool InitEdit(object obj)
        {
            try
            {
                ...
                {
                    this.edit.Text = "=" + cell.Expression;
                }
                else
                {
        ...
        public override bool DrawCell(IBaseCell cell, Feng.Drawing.GraphicsObject g)
        {
            ...
            if (cell.Value != null)
            {
                ...
                string text = Feng.Utils.CnNumber.GetString(d);
        ...
        public override bool PrintCell(IBaseCell cell, PrintArgs e, Rectangle rect)
        {
            ...
            if (decimal.TryParse(cell.Value.ToString(), out d))
            {
                ...
                DrawCell(cell, gob, cell.Rect, text);
            }
            return true;
        }
