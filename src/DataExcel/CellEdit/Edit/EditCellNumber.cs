...
{ 
    public class CellNumber : CellBaseEdit, IEdit,ICellEditControl
    {
        public override string ShortName { get { return "CellNumber"; } set { } }
        private NumTextBox edit = null;

        public CellNumber(DataExcel grid):
            base(grid)
        {
            edit = new NumTextBox();
        ...
        {
            CellNumber celledit = new CellNumber(grid);  
            return celledit;
        }
