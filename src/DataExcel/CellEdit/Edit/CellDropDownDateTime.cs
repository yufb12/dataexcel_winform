...
{
    [Serializable]
    public class CellDropDownDateTime : CellLabel, IPopupEdit
    {
        public CellDropDownDateTime(DataExcel grid)
            : base(grid)
        {
        ...
        {
            CellDropDownDateTime celledit = new CellDropDownDateTime(grid);
        ...
        private DateTimePopupForm dropdownpopupform = null;
        public void InitDropDownForm()
        {
            dropdownpopupform = new DateTimePopupForm();
        ...
        public virtual void OnOK(object value, object model)
        {
            try
            {
                ...
                if (this.Cell.FormatType == Feng.Utils.FormatType.DateTime)
                {
                    this.Cell.Text = Feng.Utils.ConvertHelper.ToString(dateTime, this.Cell.FormatString);
                }
                else
                {
