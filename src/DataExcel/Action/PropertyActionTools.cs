...
{ 
    ...
    {
        public static List<CellPropertyAction> GetCellActions(ICell cell)
        {
        ...
        public static List<DataExcelPropertyAction> GetGridActions(DataExcel grid)
        {
            ...
            model = new DataExcelPropertyAction();
            model.Grid = grid;
            model.ActionName = "PropertyBeforeLoadRow";
            model.Script = grid.PropertyBeforeLoadRow;
            model.Descript = "数据开始加载";
            model.ShortName = "BeforeLoadRow";
            list.Add(model);

            model = new DataExcelPropertyAction();
            model.Grid = grid;
            model.ActionName = "PropertyEdit";
            model.Script = grid.PropertyEdit;
            model.Descript = "编辑";
            model.ShortName = "Edit";
            list.Add(model);

            model = new DataExcelPropertyAction();
            model.Grid = grid;
            model.ActionName = "PropertyNew";
            model.Script = grid.PropertyNew;
            model.Descript = "新建";
            model.ShortName = "New";
            list.Add(model);
        ...
        public static void UpdateDataExcelPropertyAction(DataExcel grid, DataExcelPropertyAction model)
        {
            ...
            {
                case "PropertyEdit":
                    grid.PropertyEdit = model.Script;
                    break;
                case "PropertyNew":
                    grid.PropertyNew = model.Script;
                    break;
        ...
        public static string ActionScript(ICell cell,string shortname)
        {
            List<CellPropertyAction> list= GetCellActions(cell);
            foreach (CellPropertyAction item in list)
            {
                if (item.ShortName.ToLower() == shortname.ToLower())
                {
                    return item.Script;
                }
            }
        ...
        public static bool ActionScript(ICell cell, string shortname,string script)
        {
            List<CellPropertyAction> list = GetCellActions(cell);
            foreach (CellPropertyAction item in list)
            {
