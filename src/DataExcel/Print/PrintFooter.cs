...
{
    [Serializable]
    public class PrintFooter : IPrint
    {
        public PrintFooter(Print.PrintSetting printpage)
        {
        ...
        private PrintPageFooter printpageheader = null;
        public virtual void ShowPrintFooterDialog()
        {
#if DEBUG
            try
            {
                ...
                {
                    printpageheader = new PrintPageFooter();
                }
        ...
        { 
            if (_printexcel != null)
            {
                ...
                phe.CurrentPage.Rect = new Rectangle(
                    new Point(e.PrintPageEventArgs.PageBounds.Location.X, e.PrintPageEventArgs.MarginBounds.Bottom)
                    , new Size(e.PrintPageEventArgs.PageBounds.Width, e.PrintPageEventArgs.PageBounds.Bottom - e.PrintPageEventArgs.MarginBounds.Bottom));
                phe.CurrentLocation = phe.CurrentPage.Rect.Location;
