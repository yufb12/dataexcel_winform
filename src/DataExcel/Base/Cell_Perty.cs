...
//                else
//                {
//                    this.OwnEditControl = CellColumnFooter.Instance(this.Grid);
//                }
//            }
//            else if (this.Column.Index < 1)
//            {
//                this.BackColor = DataColors.HeaderColor;
//                if (this.Column.Index == 0 && this.Row.Index > 0)
//                {
//                    this.Text = (this.Row.Name);
//                }
//                this.HorizontalAlignment = StringAlignment.Center;
//                this.VerticalAlignment = StringAlignment.Center;
...
//                    {
//                        this.OwnEditControl = this.Column.DefaultCellEdit;
//                    }
...
//            //if (this.Grid.FocusedCell == this)
//            //{
//            //    backcolor = this._FocusBackColor;
//            //}
//            if (this.Rect.Contains(g.ClientPoint))
//            {

//                if (_MouseOverBackColor != Color.Empty)
//                {
//                    backcolor = this._MouseOverBackColor;
//                }
//            }
//            if (this.Grid.FocusedCell == this)
//            {
...
//                {
//                    if (_MouseDownBackColor != Color.Empty)
//                    {
//                        backcolor = this._MouseDownBackColor;
//                    }
//                }
//            }
//            if (this.Selected)
...
//#if DEBUG
//            return string.Format("RowIndex={0},ColumnIndex={1} \r\n Text={2} \r\n value={3}", this.Row.Index, this.Column.Index, this.Text, this.Value);
//#else
...
//                if (this.FunctionCells == null)
//                {
//                    this._functioncells = new List<ICell>();
//                }
...
//                foreach (ICell ce in list)
//                {
//                    if (ce != null)
//                    {
//                        this.FunctionCells.Add(ce);
//                    }
//                }
...
//                else
//                {
//                    this._value = (res == null ? string.Empty : res.ToString());
//                }
//                this.AddParent();
//                this.Grid.OnCellTextChanged(this);
//                OnValueChanged(objvalue);
//                if (this.AutoExecuteExpress)
//                {
//                    BeforeExecuteExpressArgs args = new BeforeExecuteExpressArgs(this);
//                    this.Grid.OnBeforeExecuteExpress(args);
//                    if (!args.Cancel)
//                    {
//                        if (this.OnBeforeValueChanged(res))
//                        {
//                            this.OnValueChanged(objvalue);
//                        }
//                        ExecuteExpressArgs eea = new ExecuteExpressArgs(this);
//                        this.Grid.OnExecuteExpressCompleted(eea);
//                    }
//                }
//                this.Grid.OnSetExpress(this);
//            }
//        }
...
//                {
//                    return this.Row.FocusForeColor;
//                }
...
//                if (celleditid > 0)
//                {
//                    this.OwnEditControl = this.Grid.CellSaveEdits.GetItemByID(celleditid);
//                    if (this.OwnEditControl != null)
//                    {
//                        this.OwnEditControl.Cell = this;
//                    }
...
//                this._borderStyle = stream.ReadIndex(7, this._borderStyle);
...
//                        bw.Write(7, this._borderStyle, EmptyCell._borderStyle);
...
//                        bw.Write(106, this._tablecolumnname);
//                        bw.Write(107, this._tablename);
//                        bw.Write(108, this._tablerowindex);
//                        bw.Write(109, (int)this._AllowInputExpress);
...
//        {
//            get { return Product.AssemblyInformationalVersion; }
//        }
...
//        private ImageLayout _MouseOverImageSizeMode = ImageLayout.Normal;
//        [Browsable(true)]
//        [Category(CategorySetting.Design)]
...
//        private ImageLayout _MouseDownImageSizeMode = ImageLayout.Normal;
//        [Browsable(true)]
//        [Category(CategorySetting.Design)]
...
//        #region IDisableImage 成员
//        private ImageLayout _DisableImageSizeMode = ImageLayout.Normal;
//        [Browsable(true)]
//        [Category(CategorySetting.Design)]
...
//        private ImageLayout _ReadOnlyImageSizeMode = ImageLayout.Normal;
//        [Browsable(true)]
//        [Category(CategorySetting.Design)]
...
//        private ImageLayout _FocusImageSizeMode = ImageLayout.Normal;
//        [Browsable(true)]
//        [Category(CategorySetting.Design)]
...
//        private ImageLayout _BackImgeSizeMode = ImageLayout.Normal;
//        [Browsable(true)]
//        [Category(CategorySetting.Design)]
