...
{
    [Serializable]
    public class CollectionFunctionContainer : CBMethodContainer
    {

        public const string Function_Category = "CollectionFunction";
        ...
        public CollectionFunctionContainer()
        {
            ...
            model = new BaseMethod();
            model.Name = "DictNew";
            model.Description = "DictNew()";
            model.Eg = @"DictNew()";
            model.Function = DictNew;
            MethodList.Add(model);


            model = new BaseMethod();
            model.Name = "DictAdd";
            model.Description = "DictAdd()";
            model.Eg = @"DictAdd()";
            model.Function = DictAdd;
            MethodList.Add(model);

            model = new BaseMethod();
            model.Name = "DictRemove";
            model.Description = "DictRemove()";
            model.Eg = @"DictRemove()";
            model.Function = DictRemove;
            MethodList.Add(model);

            model = new BaseMethod();
            model.Name = "DictGet";
            model.Description = "DictGet()";
            model.Eg = @"DictGet()";
            model.Function = DictGet;
            MethodList.Add(model);

            model = new BaseMethod();
            model.Name = "DictPut";
            model.Description = "DictPut()";
            model.Eg = @"DictPut()";
            model.Function = DictPut;
            MethodList.Add(model);
        }


        public virtual object DictNew(params object[] args)
        {
            Feng.Collections.DictionaryEx<object, object> dict = new Feng.Collections.DictionaryEx<object, object>();
            return dict;
        }
        public virtual object DictAdd(params object[] args)
        {
            Feng.Collections.DictionaryEx<object, object> dict = base.GetArgIndex(1, args) as Feng.Collections.DictionaryEx<object, object>;
            object key = base.GetArgIndex(2, args);
            object value = base.GetArgIndex(3, args);
            dict.Add(key, value);
            return base.OK;
        }
        public virtual object DictRemove(params object[] args)
        {
            Feng.Collections.DictionaryEx<object, object> dict = base.GetArgIndex(1, args) as Feng.Collections.DictionaryEx<object, object>;
            object key = base.GetArgIndex(2, args);
            dict.Remove(key);
        ...
        public virtual object DictGet(params object[] args)
        {
            Feng.Collections.DictionaryEx<object, object> dict = base.GetArgIndex(1, args) as Feng.Collections.DictionaryEx<object, object>;
            object key = base.GetArgIndex(2, args);
        ...
        public virtual object DictPut(params object[] args)
        {
            Feng.Collections.DictionaryEx<object, object> dict = base.GetArgIndex(1, args) as Feng.Collections.DictionaryEx<object, object>;
            object key = base.GetArgIndex(2, args);
            object value = base.GetArgIndex(3, args);
