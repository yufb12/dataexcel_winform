...
{ 
	public class AcedInflator
	{
        ...
        public void Decompress(string fromfile, string tofile)
        {
            Decompress(System.IO.File.ReadAllBytes(fromfile), tofile);
        }
        public void Decompress(byte[] data, string tofile)
        {
            System.IO.File.WriteAllBytes(tofile, Decompress(data));
        }
 
        public byte[] Decompress(byte[] data)
        {
            return Decompress(data, 0, 0, 0);
        }
