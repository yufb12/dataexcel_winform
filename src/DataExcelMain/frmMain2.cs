    ...
    public partial class frmMain2 : BaseForm, IDesignForm
    {
        ...
        void txtfunction_LostFocus(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.dataexcel.FocusedCell.Expression = string.Empty;
                    this.dataexcel.FocusedCell.Value = this.txtfunction.Text;
                }
            }
            catch (Exception ex)
            {
        ...
        private void dataexcel_FouseCellChanged(object sender, ICell cell)
        {
            ...
            try
            {
                ...
                if (this.txtCellID.Tag != null)
                {
                    ...
                    this.txtCellID.Tag = null;
                    if (tagcell != null)
                    {
                        if (!tagcell.ReadOnly)
                        {
                            if (tagcell.ID != this.txtCellID.Text)
                            {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ICell cell = this.dataexcel.GetCellByNameAndID(this.txtcell.Text);
                if (cell != null)
                {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                OnSizeChanged(e);
                this.dataexcel.LoadCompleted += Dataexcel_LoadCompleted;
            }
            catch (Exception ex)
            {
                Feng.Utils.ExceptionHelper.ShowError(ex);
        ...
        private void Dataexcel_LoadCompleted(object sender)
        {
            try
            {
                this.dataExcel1.Width = this.dataExcel1.Width+1;
            }
            catch (Exception ex)
            { 
